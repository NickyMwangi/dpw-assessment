...
$('#styleSelector').append('' +
    ...
    '<a href="#" class="navbar-theme" navbar-theme="theme5"><span class="head"></span><span class="cont"></span></a>' +
    '</div>' +
    '</li>' +
    '</ul>' +
